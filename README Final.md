...
- Página inicial com destaques para livros e folder que chamasse atenção do usuário;
...
alteração no banco de dados como  adicionar, editar e remover livros do catálogo,sendo que o banco de dados 
é simulado através de um arquivo JSON.
